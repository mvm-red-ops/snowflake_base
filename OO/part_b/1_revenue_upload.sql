-- part b of the o and o process is all about uploading the revenue
-- there are a number of partners, each with their own requirements and formats
    ...
    --  Because all of these have so few values, we can group them together on one csv 
        ...
        from (select t.$1, to_number(REPLACE(REPLACE(t.$2, '$', ''), ','), 12, 2), t.$3, to_number(REPLACE(t.$4, ','),12, 0), to_number(REPLACE(t.$4, ','),6, 2), t.$5, t.$6,  'misc_rev_q4_21'
