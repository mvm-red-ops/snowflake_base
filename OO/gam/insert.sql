...
from @onwed_and_operated_aws t) pattern='.*gam_q4_2021.*' file_format = nosey_viewership 
ON_ERROR=SKIP_FILE FORCE=TRUE;

Advertiser	Ad unit	Month and year	Advertiser ID	Ad unit ID		Total impressions	Ad Exchange revenue ($)
-	Nosey-POWR-Android (22030333158)	Oct-21	-1	22030333158	184,060	150,240	0.01