-- PLUTO_VIEWERSHIP 
    -- pluto (download viewership from https://drive.google.com/drive/u/0/folders/1e6LqTWwMYQqZUrNNF5NjzyiM50vht5Uf)
        ...
        -- pluto us
        copy into PLUTO_VIEWERSHIP( year_month_day, series, title, clip_name, total_viewing_minutes, sessions, revenue, deal_parent, territory_id, year,quarter,filename)
