...
//exact title match
select channel, wv.title, a.title, tot_hov, month, wv.ref_id FROM wurl_viewership wv
...
(
  select wv.id, channel, wv.title, a.title, tot_hov, month, a.ref_id as asset_ref_id FROM wurl_viewership wv
  join assets  a on (a.title = wv.title)
  where quarter = 'q3' and deal_parent = 16 and year = 2021 and (wv.ref_id = 'externalId' or wv.ref_id is null)
) a
...
cross join assets  a
where quarter = 'q3' and deal_parent = 16 and year = 2021  and discrep <= 2  and (wv.ref_id = 'externalId' or wv.ref_id is null)
...
(
  ...
  from wurl_viewership wv
  cross join assets  a
  where quarter = 'q3' and deal_parent = 16 and year = 2021 and (wv.ref_id = 'externalId' or wv.ref_id is null) and discrep <=2
) a
set ref_id = a.asset_ref_id
where w.id = a.id 
...
from wurl_viewership wv
cross join assets  a
where quarter = 'q3' and deal_parent = 16 and year = 2021 and (wv.ref_id = 'externalId' or wv.ref_id is null) and discrep <= 8 and a.title != 'Steve Save My Daughter'
...
from wurl_viewership wv
cross join alternative_titles  a
where quarter = 'q3' and deal_parent = 16 and year = 2021 and discrep <= 8 and (wv.ref_id = 'externalId' or wv.ref_id is null) 
...
where quarter = 'q3' and deal_parent = 16 and year = 2021 and (wv.ref_id = 'externalId' or wv.ref_id is null)  and discrep < 10 and length(a.title) > 15
...
(
  ...
  from wurl_viewership wv
  cross join alternative_titles_utility  a
  where quarter = 'q3' and deal_parent = 16 and year = 2021 and wv.ref_id is null and discrep <= 8
) a
set ref_id = a.asset_ref_id
where w.id = a.id 
